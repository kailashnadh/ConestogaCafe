<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Log.aspx.cs" Inherits="OnlineFood.Log" %>
...
<body>
    ...
    <form id="form1" runat="server" class="form-horizontal">
        ...
        <tr>
            <td class="text-center"><asp:Button ID="Button1" CssClass="button" runat="server" Text="Register" OnClick="Button1_Click"/></td>
            <td>&nbsp;</td>
        </tr>
         <tr>
             <td colspan="2">
